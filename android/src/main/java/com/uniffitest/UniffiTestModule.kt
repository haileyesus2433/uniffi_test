...
@ReactModule(name = UniffiTestModule.NAME)
class UniffiTestModule(reactContext: ReactApplicationContext) :
  NativeUniffiTestSpec(reactContext) {
  ...
  companion object {
    const val NAME = "UniffiTest"

    init {
      System.loadLibrary("react-native-uniffi-test")
    }
  }
}