...
// Automated testing checks Java_com_uniffitest_UniffiTestModule and uniffitest
// by comparing the whole line here.
/*
Java_com_uniffitest_UniffiTestModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return uniffitest::multiply(a, b);
}
*/

// Installer coming from UniffiTestModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_uniffitest_UniffiTestModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return uniffitest::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_uniffitest_UniffiTestModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return uniffitest::cleanupRustCrate(*runtime);
}